...
class HTMXFotoItemListView(generic.ListView):
...
class HTMXFotoItemCreateView(generic.CreateView):
    model = models.FotoItem
    form_class = forms.FotoItemForm
...
class HTMXFotoItemDeleteView(generic.DeleteView):
    model = models.FotoItem
    success_url = reverse_lazy("Foto_FotoItem_htmx_list")
...
class HTMXFotoBookingListView(generic.ListView):
...
class HTMXFotoBookingCreateView(generic.CreateView):
    model = models.FotoBooking
    form_class = forms.FotoBookingForm
...
class HTMXFotoBookingDeleteView(generic.DeleteView):
    model = models.FotoBooking
    success_url = reverse_lazy("Foto_FotoBooking_htmx_list")
